...
SensorPodMessages::CurrentSensorDataMessage::CurrentSensorDataMessage() {
    mData = new uint8_t[NUM_SENSOR_GROUPS * SensorGroup::NUM_SENSOR_GROUP_DATA_BYTES];
}

void SensorPodMessages::CurrentSensorDataMessage::fromSensors(const vector<SensorGroup>& sensorGroups) {
...
void SensorPodMessages::CurrentSensorDataMessage::toJSON(const vector<SensorGroup>& sensorGroups, char* jsonBuffer, int jsonBufferSize) {
